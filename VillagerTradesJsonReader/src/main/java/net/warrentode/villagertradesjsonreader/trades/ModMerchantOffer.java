...
public class ModMerchantOffer extends MerchantOffer {
    public ModMerchantOffer(CompoundTag pCompoundTag) {
        super(pCompoundTag);
    }
    public ModMerchantOffer(ItemStack payStack, ItemStack secondPayStack, ItemStack offerStack, int maxUses, int xp, float priceMult) {
